...
🎉 Explore nossas opções premium e aproveite o melhor do entretenimento com facilidade e segurança!
    `;
      ...
      console.error("Nenhum callback_data encontrado.");
    }
  } else {
...
bot
  ...
  .then(() => {
    ...
    // Fechar a conexão após 20 minutos (1200000 milissegundos)
    setTimeout(() => {
      console.log("Fechando a conexão do bot após 20 minutos...");
      bot.stop("Bot encerrado após 20 minutos.");
