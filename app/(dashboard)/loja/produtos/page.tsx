...
import { ArrowLeftCircle, ChevronLeft, ChevronRight, GalleryHorizontal, ImageIcon, Info, ShoppingBasketIcon } from "lucide-react";
  ...
  return (
    <div className="p-4 min-h-[85vh] flex flex-col gap-4 relative">
      <div className=" flex flex-col gap-4 items-center ">
        <div className=" flex justify-between bg-white rounded-md p-2 fixed z-10  w-[85%] shadow-md">
          <div className="flex gap-4 items-center ">
            ...
            </Button> <p className="border-l pl-1 font-semibold"> Layout grid</p>
          </div>
          <Button onClick={() => {

            handleUpdatePositions()
          }} disabled={loading} className="bg-blue-600 hover:bg-blue-400"> Salvar posicoes</Button>
        </div>
      ...
      <div className="p-2 bg-blue-100 border rounded-md border-blue-500 flex gap-4 items-center">
        ...
        <div> <h1><b>Layout da grade de produto</b>s</h1>
          Caso deseje alterar a posicão dos produtos basta arrastar e soltar.</div>
      </div>
      <div>
