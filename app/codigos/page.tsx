...
export default function Codigos() {
  ...
  useEffect(() => {
    const subscription = supabase
      .channel('realtime:public:codigos')
      .on(
        'postgres_changes',
        {
          event: '*',
  ...
  const codigosConcluidas = data.filter((venda) => venda.status === 'resgatado').length;
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="grid grid-cols-3 gap-6 mb-6">
        ...
        <div className="p-4 border rounded">
          <h2 className="text-xl font-semibold">Total de códigos de resgatados</h2>
